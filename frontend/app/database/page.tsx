  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Database Access</h1>
          <p className="text-[#8899A6]">Access the backend database through these API endpoints</p>
        </div>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[#8899A6]">{link.description}</p>
                </div>
              </div>
            </a>
          ))}
        ...
        <div className="mt-8 p-6 bg-[#1A1A1A] border border-[#333] rounded-lg">
          <h3 className="text-xl font-semibold text-white mb-4">How to use the API</h3>
          <div className="space-y-4 text-[#8899A6]">
            ...
            <p>
              3. For programmatic access, use the base URL: <code className="bg-[#0D0D0D] px-2 py-1 rounded">http://localhost:8000/api/v1</code>
            </p>
            <p>
