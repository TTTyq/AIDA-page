...
4. 注册或登录 Cursor 账号
   ...
   - 使用团队账号可以确保所有团队成员使用相同的 AI 模型和设置，提供一致的开发体验
...
::: tip 让 AI 帮你做
你可以直接和 AI 助手说：
"我接下来要在新分支进行开发，帮我创建和切换到一个新分支，我要做艺术家列表功能"

AI 可能会回复：
"好的，你可以使用以下命令创建并切换到新分支：
```bash
git checkout -b feature/your-name/artist-list
```
...
::: info 💪 成为 AI 编程大师
掌握了这些高级技巧，你将不再是 AI 的简单使用者，而是能够驾驭 AI 的编程大师！想象一下，当你的同事还在为一个功能苦苦挣扎时，你已经用 AI 完成了三个功能的开发。这就是 AI 时代的"编程超能力"！
:::
